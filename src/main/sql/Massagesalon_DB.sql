...
CREATE TABLE IF NOT EXISTS Massagetyp (
                                          MTypID VARCHAR(8) PRIMARY KEY, -- Laut Angabe 8-stellig alphanumerisch
...
CREATE TABLE IF NOT EXISTS Ort (
                                   Raumcodierung VARCHAR(7) PRIMARY KEY, -- Laut Angabe 7-stellig
...
CREATE TABLE IF NOT EXISTS Masseur (
    ...
    Ausbildungszeit INT NOT NULL,      -- z.B. in Monaten
